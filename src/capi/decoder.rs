...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderCreate() -> *mut avifDecoder {
    Box::into_raw(Box::<avifDecoder>::default())
}

#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderSetIO(decoder: *mut avifDecoder, io: *mut avifIO) {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderSetIOFile(
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderSetIOMemory(
    decoder: *mut avifDecoder,
    data: *const u8,
    size: usize,
) -> avifResult {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderSetSource(
    decoder: *mut avifDecoder,
    source: Source,
) -> avifResult {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderParse(decoder: *mut avifDecoder) -> avifResult {
    unsafe {
        let rust_decoder = &mut (*decoder).rust_decoder;
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderNextImage(decoder: *mut avifDecoder) -> avifResult {
    unsafe {
        let rust_decoder = &mut (*decoder).rust_decoder;
        rust_decoder.settings = (&(*decoder)).into();
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderNthImage(
    decoder: *mut avifDecoder,
    frameIndex: u32,
) -> avifResult {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderNthImageTiming(
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderDestroy(decoder: *mut avifDecoder) {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderRead(
    decoder: *mut avifDecoder,
    image: *mut avifImage,
) -> avifResult {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderReadMemory(
    decoder: *mut avifDecoder,
    image: *mut avifImage,
    data: *const u8,
    size: usize,
    ...
    unsafe {
        let res = CRABBYAVIF_avifDecoderSetIOMemory(decoder, data, size);
        if res != avifResult::Ok {
            return res;
        }
        CRABBYAVIF_avifDecoderRead(decoder, image)
    }
}

#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderReadFile(
    decoder: *mut avifDecoder,
    image: *mut avifImage,
    filename: *const c_char,
) -> avifResult {
    unsafe {
        let res = CRABBYAVIF_avifDecoderSetIOFile(decoder, filename);
        if res != avifResult::Ok {
            return res;
        }
        CRABBYAVIF_avifDecoderRead(decoder, image)
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderIsKeyframe(
    decoder: *const avifDecoder,
    frameIndex: u32,
) -> avifBool {
    let rust_decoder = unsafe { &(*decoder).rust_decoder };
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderNearestKeyframe(
    decoder: *const avifDecoder,
    frameIndex: u32,
) -> u32 {
    let rust_decoder = unsafe { &(*decoder).rust_decoder };
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderDecodedRowCount(decoder: *const avifDecoder) -> u32 {
    let rust_decoder = unsafe { &(*decoder).rust_decoder };
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDecoderNthImageMaxExtent(
    decoder: *const avifDecoder,
    frameIndex: u32,
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifPeekCompatibleFileType(
