...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifResultToString(_res: avifResult) -> *const c_char {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifCropRectConvertCleanApertureBox(
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifGetPixelFormatInfo(
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifDiagnosticsClearError(diag: *mut avifDiagnostics) {
    if diag.is_null() {
        return;
    }
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifAlloc(size: usize) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifFree(p: *mut c_void) {
    if !p.is_null() {
