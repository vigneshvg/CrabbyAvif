...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifRWDataRealloc(
    raw: *mut avifRWData,
    newSize: usize,
) -> avifResult {
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifRWDataSet(
    raw: *mut avifRWData,
    data: *const u8,
    size: usize,
) -> avifResult {
    unsafe {
        if size != 0 {
            let res = CRABBYAVIF_avifRWDataRealloc(raw, size);
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifIOCreateMemoryReader(
    data: *const u8,
    size: usize,
) -> *mut avifIO {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifIOCreateFileReader(filename: *const c_char) -> *mut avifIO {
...
#[no_mangle]
pub unsafe extern "C" fn CRABBYAVIF_avifIODestroy(io: *mut avifIO) {
    unsafe {
